...
public class AddressBookApplicationTests {
    ...
    @Test
    public void homePostAddressBook() throws Exception {
    ...
    @Test
    public void homePostBuddyInfo() throws Exception {
    ...
    @Test
    public void homePatchAddBuddiesToAddressBook() throws Exception {
        String url = "http://localhost:" + port;
    ...
    @Test
    public void homeDeleteBuddyFromAddressBook() throws Exception {
        String url = "http://localhost:" + port;
